...
WHERE UPPER(L.CITY)='OXFORD'
AND 
UPPER(E.JOB_ID)='IT_PROG';

--08.WAQD--those employees who has 6 digit salary and firstname contains letter
--         p at 5th position and joined company before 2006
SELECT *
FROM EMPLOYEES
WHERE SALARY LIKE '______'
AND FIRST_NAME LIKE '%____p%'
